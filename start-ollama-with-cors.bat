...
REM Set the OLLAMA_ORIGINS environment variable to allow the hosted site and all tremech.us subdomains
set OLLAMA_ORIGINS=https://*.tremech.us,http://localhost:3000,http://127.0.0.1:3000
